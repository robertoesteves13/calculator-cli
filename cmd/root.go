...
var rootCmd = &cobra.Command{
	Use:   "calculator-cli",
	Short: "A simple CLI calculator made in Golang",
	Long: `A simple CLI program made in Golang for calculating arithmetic
    operations, just like a calculator. Made to practice Golang.`,
